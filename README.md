...
backend:
  name: [github | gitlab]
  repo: JoanGarfias/repo # Path to your Github/Gitlab repository
  branch: main # Branch to update
  base_url: https://netlify-cms.repo.vercel.app
```
...
- Create Github OAuth App:
  ...
  - Set `Authorization callback URL` to your deployed oauth website's callback URL:
    `https://netlify-cms.repo.vercel.app/callback`
